...
# === Load your trained object detector ===
object_model = YOLO("best_5.pt").to(device)
...
print("Real-time Object Detection + Zone Monitoring Started (press 'q' to quit)")
...
while True:
    ...
    for i, (obj_res, frame) in enumerate(zip(obj_results, frames)):
        cam_label = f"Cam{i+1}"
